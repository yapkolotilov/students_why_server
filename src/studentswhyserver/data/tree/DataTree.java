...
public class DataTree implements Serializable {
    ...
    protected void changeLeaf(DataTreeLeaf leaf, String newID, Object newValue) throws DuplicateElemException {
        studentswhyserver.debug.Console.println(leaf.getID());
        studentswhyserver.debug.Console.println((newID));
        studentswhyserver.debug.Console.println(leaf.getID().equals(newID));
